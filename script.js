...
const WATER_DATA = {
    ...
    suino: {
        litros: 35,
        sugestoes: [
            "Regule a altura e a pressão das chupetas dos bebedouros regularmente para evitar que os animais desperdicem água.",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    tabButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            // Pega o ID alvo e exibe a seção correspondente
